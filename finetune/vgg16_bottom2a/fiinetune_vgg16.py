...
bottom_model.add(Convolution2D(32, 3, 3, activation='relu', name='conv1_1'))
bottom_model.add(ZeroPadding2D((1, 1)))
bottom_model.add(Convolution2D(3, 3, 3, activation='relu', name='conv1_2'))
...
bottom_model.load_weights('bottom2_model.h5')

for layer in bottom_model.layers[4].layers[:25]:
